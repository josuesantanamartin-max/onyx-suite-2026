...
export const DEFAULT_LAYOUTS: DashboardLayout[] = [
  {
    ...
    widgets: [
      ...
      { i: 'CATEGORY_CHART', x: 0, y: 4, w: 12, h: 3, visible: true },
      { i: 'ACTIVE_GOALS', x: 0, y: 7, w: 6, h: 2, visible: true },
      { i: 'ACTIVE_DEBTS', x: 6, y: 7, w: 6, h: 2, visible: true },
      { i: 'MONTHLY_GOALS', x: 0, y: 9, w: 6, h: 2, visible: true },
      { i: 'SPENDING_FORECAST', x: 6, y: 9, w: 6, h: 2, visible: true },
      { i: 'TIMELINE_EVOLUTION', x: 0, y: 11, w: 12, h: 3, visible: true },
      { i: 'EXPLORER', x: 0, y: 14, w: 12, h: 3, visible: true },
    ],
  },
  {
    id: 'detailed',
