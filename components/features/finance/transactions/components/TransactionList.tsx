    ...
    return (
        <div className="space-y-12">
            {sortedDates.map(date => (
                <div key={date} className="animate-fade-in group/day">
                            ...
                            <div key={t.id} onClick={() => onEdit(t)} className="p-8 hover:bg-onyx-50/50 transition-all duration-300 group/item flex flex-col sm:flex-row items-center gap-8 cursor-pointer border-l-4 border-l-transparent hover:border-l-indigo-primary">
                                ...
                                <div className="flex-1 text-center sm:text-left">
                                    <div className="flex items-center justify-center sm:justify-start gap-4 mb-3">
                                        ...
                                        {t.isRecurring && (
                                            <div className="flex items-center gap-2 px-2.5 py-1 bg-indigo-50 text-indigo-primary rounded-lg border border-indigo-100">
                                    ...
                                    <div className="flex flex-wrap justify-center sm:justify-start gap-4">
                                        ...
                                        <div className="text-onyx-400 font-bold text-[11px] self-center flex items-center gap-3 bg-white px-3 py-1.5 rounded-xl border border-onyx-100/50 group-hover/item:border-indigo-100 transition-colors">
